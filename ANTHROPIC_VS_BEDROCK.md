...
| MCP Connector | ✅ | ❌ | ❌ | **完全不支持** |
| Memory Tool | ✅ | ❌ | ❌ | **完全不支持** |
| Bash / Computer Use / Text Editor Tool | ✅ | ❌ | ❌ | **完全不支持** |
| Agent Skills | ✅ | ❌ | ❌ | **完全不支持** |
...
| 维度 | 说明 |
|------|------|
| **Anthropic** | `bash_20250124`、`computer_20250124`、`text_editor_20250124`。Beta header: `computer-use-2025-01-24`。Claude 直接执行 bash 命令、操作计算机界面、编辑文件 |
| **Bedrock** | **不支持** |
...
- Workaround 参考:
  ...
  - 本项目 InvokeModel API 透传: [https://github.com/xiehust/anthropic_api_converter/blob/main/app/services/bedrock_service.py](https://github.com/xiehust/anthropic_api_converter/blob/main/app/services/bedrock_service.py)
